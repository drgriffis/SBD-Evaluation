...
srcd=/vagrant/data/swb/plaintext
outd=/vagrant/data/swb/splitta-output
...
cat << EOF
Running SPLITTA parser to find sentence boundaries on SWB corpus
  Src data: $srcd
  Output to: $outd
  Bounds to: $bounds
